...
function productDeleteReducer(state= {product: {}}, actions){

    switch (actions.type) {
        case PRODUCT_DELETE_REQUEST:
            return {loading: true};
        case PRODUCT_DELETE_SUCCESS:
            return {loading: false, product: actions.payload, success: true};
...
function productSaveReducer(state= {product: {}}, actions){
